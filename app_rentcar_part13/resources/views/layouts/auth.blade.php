@php
    if (!isset($valid_jwt)){$valid_jwt="TRUE";}
...
<!-- Authentication Links -->
    ...
    @if ($valid_jwt=="TRUE")
        <li class="nav-item">
        <a type="button" class="nav-link btn btn-outline" onclick="myLogout()">Logout</a>
        </li>
       <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" onclick="myLogout()">Logout</a>

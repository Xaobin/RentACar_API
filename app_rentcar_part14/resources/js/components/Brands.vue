...
<dmodal-cp modalname="modalUpd" title="Update brand">
    ...
    <alert-cp stll="danger" title="error in Transaction" :details="$store.state.transact" v-if="$store.state.transact.status == 'error'"></alert-cp>
     ...
     <div class="form-group">
        ...
        <input type="text" class="form-control" id="updName" ref="updName" aria-describedby="updNameHelp">
        </input-cp> 
        </div>
...
<script>
 ...
 setUpdateValues(){
   ...
   if (this.$refs.updName!=undefined){
    ...
    if (this.$refs.inputFile!=undefined){
      //console.log(this.$refs.updImage.value);
      //this.$refs.inputFile.value=null;
      //this.fileImage[0]='';
      //this.$set(this.$refs.inputFile,'updName','');
 
   }


    //console.log("..."+this.namebrand);
    //console.log("..."+this.$store.state.transact.status);
 },
 /* . . . . . . . . . . . . . . . . . . . */
  printValues(){
   this.fileInputKey=0;
   this.$set(this.fileImage[0],'name','');
  ...
  //if (this.$refs.updImage!=undefined){
 //     console.log(this.$refs.updImage.value);
 //  }
 ...
 /* . . . . . . . . . . . . . . . . . . . */
        updateh() {
        this.namebrand=this.$refs.updName.value;    
 ...
 /* . . . . . . . . . . . . . . . . . . . */
        deleteh() {
                ...
                axios.post(url, formData)
                    ...
                    .catch(errors => {
                        this.$store.state.transact.status = 'error'
                        this.$store.state.transact.message = errors.response.data.error
                    })
                  this.loadList();  
